...
const Honors =() => {
    return(
      ...
      <div className={`ml-8`}>
        ...
        <p className={'p-1'}> <span>Finalist, Narrative Magazine “Tell Me a Story” High School Contest, judged by Jericho Brown  </span><span className="text-xs">(2022)</span></p>
        ...
        <p className={'p-1'}> <span>Passages North's Elinor Benedict Poetry Prize </span><span className="text-xs">(2021)</span></p>
        ...
        <p className={'p-1'}> <span>Honorable Mention, Princeton University's Leonard L. Milberg Poetry Prize </span><span className="text-xs">(2021)</span></p>
        <p className={'p-1'}> <span>Honorable Mention, Kenyon Review's Patricia Grodd Poetry Prize </span><span className="text-xs">(2021)</span></p>
        <p className={'p-1'}> <span>Shortlisted, Sine Theta Summer Writing Contest, judged by RF Kuang </span><span className="text-xs">(2021)</span></p>
