  ...
  const honors = [
    ...
    { title: "Finalist, Narrative Magazine 17th Annual Poetry Contest", year: 2025 },
    {
      title: (
        <>
          <a
            href="https://poetrysociety.org.uk/competitions/national-poetry-competition/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Commended Poet, National Poetry Competition
          </a>
        </>
      ),
      year: 2024,
    ...
    { title: <><em>Elinor Benedict Poetry Prize</em>, <em>Passages North</em></>, year: 2021 },
    ...
    { title: <><em>Honorable Mention</em>, <em>The Kenyon Review</em>’s Patricia Grodd Poetry Prize</>, year: 2021 },
    { title: <><em>Shortlist</em>, <em>Sine Theta</em> Summer Writing Contest, judged by R.F. Kuang</>, year: 2021 },
  ];
