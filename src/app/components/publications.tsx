...
const Publications =() => {
 ...
 text-black font-zen-old-mincho ${styles.WritingSection}}`}>
      ...
      <div className={`ml-8`}> 
            ...
            <p className={'p-1'}><a className="journ" href="https://northbynorthwestern.com/sense-track-understand-northwestern-professor-karan-ahuja-and-the-spice-lab/">Sense, track, understand: Northwestern Professor Karan Ahuja and the SPICE Lab</a> <span className="text-xs p-2">in <em>North By Northwestern</em> </span> <span className="text-xs">(November 2024)</span></p>
