...
const Publications =() => {
    return(
      ...
      <div className={`ml-8`}> 
            ...
            <p className={'p-1'}><a className="journ" href="https://northbynorthwestern.com/writing-lust-in-luster-a-raven-leilani-reading/"> Raven Leilani talks writing lust in 'Luster'</a> <span className="text-xs p-2">in <em>North By Northwestern</em> </span> <span className="text-xs">(March 2024)</span></p>
