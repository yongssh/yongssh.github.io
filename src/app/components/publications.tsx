...
const Publications =() => {
    return(
      ...
      <div className={`ml-8`}> 
            ...
            <p className={'p-1'}> <a className="journ" href="https://penangmonthly.com/article/20897/facing-abstract-creatures-makes-them-relatable-in-penang"> Syrian Sculptor Aboud Fares's Abstract Creatures</a> <span className="text-xs p-2">  in <em>Penang Monthly</em> </span> <span className="text-xs">(May 2023)</span></p>
            ...
            <p className={'p-1'}> <a className="journ" href="https://penangmonthly.com/article/20725/dropping-poetry-art-on-unsuspecting-readers"> Trina Teoh's Public Poetry Art Installations</a> <span className="text-xs p-2">  in <em>Penang Monthly</em> </span> <span className="text-xs">(Sept 2022)</span></p>
