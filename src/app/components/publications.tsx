...
const Publications =() => {
    return(
      ...
      <br></br>
      <div className={`ml-8`}>
      <p className={'p-1'}><a className="journ" href="https://dailynorthwestern.com/2024/05/16/campus/center-for-native-american-and-indigenous-research-hosts-6th-annual-symposium-on-indigenous-futures/">
            Indigenous Futures Research Symposium </a> <span className="text-xs p-2">in <em>The Daily Northwestern</em> </span> <span className="text-xs">(May 2024)</span></p>
            ...
            <p className={'p-1'}> <a className="journ" href="https://penangmonthly.com/article/20576/addressing-cultural-taboos-and-alleviating-period-poverty"> Period Poverty and Cultural Taboos</a> <span className="text-xs p-2"> in <em>Penang Monthly</em></span> <span className="text-xs">(March 2022)</span></p>
