...
const Publications =() => {
    return(
      ...
      <div className={`ml-8`}> 
            ...
            <p className={'p-1'}> <a className="journ" href="https://penangmonthly.com/claiming-right-of-place-in-malaysian-cinema-for-indigenous-stories"> Indigenous Malaysian Filmmaker Nadira Ilana</a> <span className="text-xs p-2">  in <em>Penang Monthly</em> </span> <span className="text-xs">(December 2021)</span></p>
            <p className={'p-1'}> <a className="journ" href="https://www.penangmonthly.com/malaysian-cinema-an-intricate-tale-of-pride-and-prejudice/"> Malaysian Cinema: An Intricate Tale of Pride and Prejudice </a> <span className="text-xs p-2">  in <em>Penang Monthly</em> </span> <span className="text-xs">(December 2021)</span></p>
